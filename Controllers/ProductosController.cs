...
using tienda20260225.Models;

namespace tienda20260225.Controllers
{
    public class ProductosController : Controller
    {
        private readonly TiendaDb2026Context _context;

        public ProductosController(TiendaDb2026Context context)
        {
            _context = context;
        }
        ...
        {
            var tiendaDb2026Context = _context.Productos.Include(p => p.Categoria);
            return View(await tiendaDb2026Context.ToListAsync());
        }
